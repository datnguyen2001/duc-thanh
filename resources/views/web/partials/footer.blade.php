        ...
        <div class="row">
            @php
                ...
                $setting = App\Models\SettingModel::first();
                    if ($currentLocale == 'vi') {
                                        $setting->addresss = $setting->address;
                                    } else if ($currentLocale == 'en') {
                                        $setting->addresss = $setting->address_en;
                                    }
            @endphp
                ...
                <div class="row information-content">
                    <div class="col-lg-6 col-12">
                        <div class="contact-content">
                            <img class="logo w-100" src="{{asset($setting->logo??'assets/images/header/Logo.png')}}"
                                 alt="logo" style="max-width: 292px"/>
                            <div class="contact-info">
                                <p><strong>{{__('footer.address')}} </strong> {{$setting->addresss ?? ''}}</p>
                    ...
                    <div class="col-lg-6 col-12 d-flex">
                        ...
                        <div class="product col-6">
                            ...
                            @foreach($categories as $category)
                                ...
                                @endphp
                                <p><a href="{{route('category-product', [$category->slug])}}">{{$category->names}}</a>
                                </p>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-12 text-center">
                <div class="social-icons" id="social-icon-desktop">
                    <div class="col-12">
                        <a href="https://zalo.me/{{$setting->zalo ?? ''}}" target="_blank" class="footer-zalo"><img
                                src="{{asset('assets/images/footer/zalo.png')}}" alt="Zalo"></a>
                        <a href="{{$setting->tiktok ?? '#'}}" target="_blank" class="footer-tiktok"><img
                                src="{{asset('assets/images/footer/tiktok.png')}}" alt="TikTok"></a>
                    </div>
                    <div class="col-12">
                        <a href="{{$setting->facebook ?? '#'}}" target="_blank" class="footer-facebook"><img
                                src="{{asset('assets/images/footer/fb.png')}}" alt="Facebook"></a>
                        <a href="{{$setting->youtube ?? '#'}}" target="_blank" class="footer-youtube"><img
