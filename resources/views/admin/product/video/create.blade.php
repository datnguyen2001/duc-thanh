    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{route('admin.product-video.store-video',$id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-3">Tên kênh video :</div>
                        <div class="col-8">
                            <input class="form-control" name="channel_name" type="text" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-5">
                        <div class="col-12 d-flex justify-content-center">
                            ...
                            <a href="{{route('admin.product-video.index-video',$id)}}" class="btn btn-danger">Hủy</a>
                        </div>
