                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a class="btn btn-success"
                                   href="{{route('admin.product-video.create-video',$id)}}">Thêm video sản phẩm</a>
                            </div>
                            <table class="table">
                                ...
                                @if(count($listData))
                                    @foreach($listData as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{url('admin/product-video/edit-video/'.$value->id)}}"
                                                       class="btn btn-icon btn-light btn-hover-success btn-sm"
                                                       data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                       data-bs-original-title="Cập nhật">
                                                        <i class="bi bi-pencil-square "></i>
                                                    </a>
                                                    <a href="{{url('admin/product-video/delete-video/'.$value->id)}}"
