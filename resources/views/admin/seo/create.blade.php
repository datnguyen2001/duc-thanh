                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <select name="type" class="form-control" required>
                                ...
                                <option value="3">Trang hoạt động</option>
                                <option value="4">Trang danh mục sản phẩm</option>
                                <option value="5">Trang giới thiệu</option>
                                <option value="6">Trang liên hệ</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-3">
