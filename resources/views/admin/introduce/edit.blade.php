        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Cập nhật giới thiệu</h5>

                            <form action="{{url("admin/introduce/update",$news->id)}}" method="post"
                                ...
                                <div class="card mb-5">
                                    ...
                                    <div class="card-body mt-2">
                                        <textarea name="content" class="ckeditor" maxlength="3000">{!! $news->content !!}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8">
                                        <div class="form-control position-relative div-parent" style="padding-top: 50%">
                                            <div class="position-absolute w-100 h-100 div-file" style="top: 0; left: 0;z-index: 10">
                                                ...
                                                <img src="{{asset($news->src)}}" class="w-100 h-100" style="object-fit: cover">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="index" required class="form-control" value="{{$news->index}}">
                                    </div>
                                </div>
