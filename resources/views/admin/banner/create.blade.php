            ...
            <div class="bg-white p-4">
                <form action="{{route('admin.banner.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <div class="form-control position-relative" style="padding-top: 50%">
                                <button type="button" class="position-absolute border-0 bg-transparent select-image-mobile" style="top: 50%;left: 50%;transform: translate(-50%,-50%)">
                                    <i style="font-size: 30px" class="bi bi-download"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input type="number" class="form-control" name="index" value="1">
                        </div>
                    </div>
                    <div class="row mt-3">
...
@section('script')
    <script>
        ...
        function imgPreviewMobile(input) {
            ...
            let filetype_mobile = mixedfile_mobile[0];
