    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{url("admin/image-detail/update-image",$data->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mt-3">
                    ...
                    <div class="row mt-5">
                        <div class="col-12 d-flex justify-content-center">
                            ...
                            <a href="{{route('admin.image-detail.index-image',$id)}}" class="btn btn-danger">Hủy</a>
                        </div>
